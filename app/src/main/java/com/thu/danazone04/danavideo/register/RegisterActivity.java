package com.thu.danazone04.danavideo.register;
...
import com.thu.danazone04.danavideo.BaseActivity;
import com.thu.danazone04.danavideo.MainActivity_;
import com.thu.danazone04.danavideo.R;
import com.thu.danazone04.danavideo.SessionManager;
import com.thu.danazone04.danavideo.common.Common;
import com.thu.danazone04.danavideo.common.MySingleton;
import com.thu.danazone04.danavideo.dialog.SexDialog;
import com.thu.danazone04.danavideo.login.LoginActivity_;
import com.thu.danazone04.danavideo.utils.ConnectionUtil;
            ...
            switch (v.getId()) {
                ...
                case R.id.mTvSubmit:
                    ...
                    if (email.equals("") || !isEmailValid(email)) {
                        showAlertDialog("Email không được trống hoặc không đúng định dạng!");
                        return;
                    }
